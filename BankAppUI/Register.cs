...
namespace BankAppUI
{
    public partial class Register : Form
    {
        ...
        private void txtFirstName_Validating(object sender, CancelEventArgs e)
        {
            ...
            else if(!_validators.ValidateName(txtFirstName.Text))
            {
                e.Cancel = true;
                txtFirstName.Focus();
        ...
        private void txtLastName_Validating(object sender, CancelEventArgs e)
        {
            ...
            else if (!_validators.ValidateName(txtLastName.Text))
            {
                e.Cancel = true;
                txtLastName.Focus();
        ...
        private void txtEmail_Validating(object sender, CancelEventArgs e)
        {
            ...
            else if (!_validators.ValidateEmail(txtEmail.Text))
            {
                e.Cancel = true;
                txtEmail.Focus();
        ...
        private void txtPassword_Validating(object sender, CancelEventArgs e)
        {
            ...
            else if (!_validators.ValidatePassword(txtPassword.Text))
            {
                e.Cancel = true;
                txtPassword.Focus();
